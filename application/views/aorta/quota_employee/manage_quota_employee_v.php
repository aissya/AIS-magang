                            ...
                            <table id="dataTables2" class="table table-condensed table-striped table-hover display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $isi) {
                                        ...
                                        if ($isi->KADEP_APPROVE == 1 && $isi->GM_APPROVE == 0 && $isi->DIR_APPROVE == 0) {
                                            $color = '#F5811E';
                                        }
                                        if ($isi->KADEP_APPROVE == 1 && $isi->GM_APPROVE == 1 && $isi->DIR_APPROVE == 0) {
                                            $color = '#FFCA01';
                                        }
                                        if ($isi->KADEP_APPROVE == 1 && $isi->GM_APPROVE == 1 && $isi->DIR_APPROVE == 1) {
                                            $color = '#55D785';
                                        }
                        ...
                        <div style="width: 100%;padding-bottom:10px;">
                            <table width="100%" id='filterx' border=0px style="outline: thin ridge #DDDDDD">
                                <tr>
                                    ...
                                    <td width="10%">
                                        <button disabled style='border:0;background:#FE2D45;width:50px;height:10px;color:white;'></button> : Not Yet Approved
                                    </td>
                                    <td width="10%">
                                        <button disabled style='border:0;background:#F5811E;width:50px;height:10px;color:white;'></button> : Approved By MGR
                                    </td>
                                    <td width="10%">
                                        <button disabled style='border:0;background:#FFCA01;width:50px;height:10px;color:white;'></button> : Approved By GM
                                    </td>
                                    <td width="10%">
                                        <button disabled style='border:0;background:#55D785;width:50px;height:10px;color:white;'></button> : Approved By DIR*
                                    </td>
                                </tr>
                            </table>
                        </div>
