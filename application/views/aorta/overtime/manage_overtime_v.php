                                    ...
                                    <td width="10%" style='text-align:left;' colspan="4">
                                        <select id="opt_wcenter" onChange="document.location.href = this.options[this.selectedIndex].value;" class="ddl">
                                            ...
                                            <?php foreach ($all_section as $row) { ?>
                                                <option value="<?php echo site_url('aorta/overtime_c/index/' . $period . '/' . trim($dept) . '/' . $row->KODE); ?>" <?php
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $isi) {
                                        ...
                                        if ($isi->CEK_KADEP == 1 && $isi->CEK_GM == 0) {
                                            $color = 'background:#FE8F03;color:#fff;';
                                        }
                        ...
                        <div style="width: 60%;">
                            <table width="40%" id='filter' border=0px style="outline: thin ridge #DDDDDD">
                                <tr>
                                    ...
                                    <td width="10%">
                                        <button disabled style='border:0;background:#FE8F03;width:25px;height:25px;color:white;'></button> : Approved by MGR
                                    </td>
                                    <td width="10%">
                                        <button disabled style='border:0;background:#55D785;width:25px;height:25px;color:white;'></button> : Approved by MGR & GM
                                    </td>
                                </tr>
                            </table>
