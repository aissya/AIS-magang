...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#"><strong>Belum Cek GM</strong></a></li>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>BELUM CEK GM </strong></span>
                        <div class="pull-right grid-tools">

                        </div>
                    </div>
                    <div class="grid-body">
                        <a href="<?php echo site_url('index.php/aorta/download_spkl_c/index/') ?>" class="btn-detail-class btn btn-primary" type="button" <i></i>Back</a>
                            ...
                            <div id="table-luar">
                                <table id="dataTables3" class="table table-condensed  table-striped table-hover display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($belum_GM_data_download as $isi) : ?>
                                            <tr>
